  ...
  function Gerar()
  {
    ...
    if ($obj_permissoes->permissao_cadastra(578, $this->pessoa_logada, 7)) {
      ...
      if ($registro['aprovado'] == 3 &&
        ...
        if ($nm_turma) {
          $this->array_botao[]            = 'Reemitir Comprovante';
          $this->array_botao_url_script[] = 'printComprovante()';
        }
      ...
      if ($registro['aprovado'] != 4 && $registro['aprovado'] != 6 && ($registro['ref_ref_cod_serie'] && isset($nm_turma))) {
...
$pagina->MakeAll();
?>
<?php if (isset($_GET['print']) && $_GET['print'] == 'comprovante'): ?>
...
{
  window.open(
    'educar_matricula_comprovante.php?ref_cod_matricula=<?php print $_GET['cod_matricula'] ?>',
    'printwin',
