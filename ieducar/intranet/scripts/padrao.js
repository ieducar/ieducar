...
function formataData(campo, e) {
    if (typeof window.event != 'undefined') {
        ...
        if (e.which != 47 && e.which != 45 && e.which != 46 && e.which != 8 &&
...
function formataHora(campo, e) {
    if (typeof window.event != 'undefined') {
        ...
        if (e.which != 45 && e.which != 46 && e.which != 8 && e.which != 32 &&
...
function formataFone(campo, e) {
    if (typeof window.event != 'undefined') {
        ...
        if (window.event.keyCode != 45 && campo.value.length == 8 &&
...
function cv_set_campo(campo1, valor1, campo2, valor2, campo3, valor3, campo4, valor4, campo5, valor5, campo6, valor6, campo7, valor7, campo8, valor8, campo9, valor9, campo10, valor10, campo11, valor11, campo12, campo13, valor13, campo14, valor14) {
