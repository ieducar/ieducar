...
class EducacensoParser {
    ...
    private $rows = array (
            ...
            "10" => "Escola/Estrutura",
            "20" => "Turma",
            "30" => "Profissional Docente",
            "40" => "Profissional Docente/Documentos e Endereco",
            "50" => "Profissional Docente/Dados Variaveis",
            "51" => "Profissional Docente/Dados Docentes",
            "60" => "Alunos",
            "70" => "Alunos/Documentos e Endereco",
            "80" => "Alunos/Matriculas" 
    );
    ...
    public function run() {
        ...
        foreach ( $contents as $text_row ) {
            $data = parse_row ( explode ( '|', $text_row ) );
        }
    }
}
